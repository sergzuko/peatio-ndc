...
RSpec.describe Peatio::Ndc::Blockchain do
  ...
  context :configure do
    ...
    it "currencies and server configuration" do
      currencies = [{id: :ndc,
                      ...
                      options: {}}]
      settings = {server: "http://admin:admin@127.0.0.1:27798",
  ...
  context :latest_block_number do
    ...
    let(:server) { "http://admin:admin@127.0.0.1:27798" }
  ...
  context :build_transaction do
    ...
    context "three vout tx" do
      ...
      let(:blockchain) do
        Peatio::Ndc::Blockchain.new.tap {|b| b.configure(currencies: [currency]) }
      end
    ...
    context "multiple currencies" do
      ...
      let(:blockchain) do
        Peatio::Ndc::Blockchain.new.tap do |b|
  ...
  context :fetch_block! do
    ...
    let(:server_without_authority) { "http://127.0.0.1:27798" }
    let(:blockchain) do
      Peatio::Ndc::Blockchain.new.tap {|b| b.configure(server: server, currencies: [currency]) }
    end
